      ...
      <el-row>
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.touxiang" label="头像" prop="touxiang">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.touxiang.split(',')" :src="getImageUrl(item)" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    getImageUrl(imageUrl) {
      ...
      // 拼接完整的图片路径
      return this.$base.url + 'upload/' + imageUrl;
    },
